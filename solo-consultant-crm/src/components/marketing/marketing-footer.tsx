    ...
    <footer className="bg-neutral-900 text-neutral-400">
      <div className="max-w-7xl mx-auto py-16 px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {['Websites', 'Web Apps', 'Mobile Apps', 'CRMs & ERPs'].map(item => (
                <li key={item}>
                  <a href="#services" className="text-sm text-neutral-400 hover:text-white transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="mailto:hello@aidevsquad.com" className="text-sm text-neutral-400 hover:text-white transition-colors">Contact</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-500">&copy; {new Date().getFullYear()} AI Dev Squad. All rights reserved.</p>
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-neutral-400 hover:text-white transition-colors" aria-label="X (Twitter)">
